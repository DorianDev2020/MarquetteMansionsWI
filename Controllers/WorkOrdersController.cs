...
{
    [Authorize(Roles = "Manager, Tennant")]
    public class WorkOrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TenantId,MaintenanceOrder")] WorkOrder workOrder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TenantId,MaintenanceOrder")] WorkOrder workOrder)
        {
            if (id != workOrder.Id)
            {
                return NotFound();
